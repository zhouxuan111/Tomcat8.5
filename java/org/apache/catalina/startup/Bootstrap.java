 ...
 * 作为应用服务器的启动入口，启动tomcat 通过该类的main()方法
 * 负责创建Cataline实例
 */
public final class Bootstrap {
    ...
    /**
     * 创建tomcat的类加载器对象，从catalina.properties文件中获取common.loader,catalina.loader,shared.loader
     * 的值，创建Repository对象，并且返回URLClassLoader
     * @param name
     * @param parent
     * @return
     * @throws Exception
    ...
    public void init() throws Exception {
        ...
        // 通过类加载器加载Catalina的Class对象，并通过反射创建对象

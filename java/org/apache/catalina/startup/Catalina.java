 ...
 * 理解为Servlet容器
 * 用于解析server.xml的各个组件的配置信息,并且负责启动和停止服务器
 */
public class Catalina {
    ...
    protected Digester createStartDigester() {
        ...
        /*--------------创建Server实例---------------*/
        // 匹配到Server节点的时候，创建StandardServer对象
        ...
        // 调用Server.setService()设置Service到Server中
        ...
        /*---------------为Service添加线程池，Executor的共享级别是Services--------------*/
